...
import { X, Trash2, ArrowRight, Pencil, Sparkles } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-slide-in">
        ...
        <div className="p-4 bg-gray-100 border-t border-gray-200">
          <div className="flex justify-between items-center mb-4">
            <span className="font-tech text-gray-600 font-bold text-lg">SUMA CAŁKOWITA:</span>
            <span className="font-mono text-2xl font-bold text-poke-dark">{total.toFixed(2)} zł</span>
          </div>
          <button 
